...
# bash -c "$(wget -qLO - https://raw.githubusercontent.com/NicholasLambell/ProxmoxVE/main/misc/copy-data/home-assistant-core-copy-data-home-assistant-container.sh)"
